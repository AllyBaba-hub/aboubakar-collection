(() => {
    ...
    async function refreshSalesDashboard() {
        setStatusText(salesStatus, "Loading sales...");
        try {
    ...
    function subscribeSalesRealtime() {
        supabaseClient
            ...
            .on("postgres_changes", { event: "INSERT", schema: "public", table: "sales" }, queueSalesRefresh)
            .on("postgres_changes", { event: "UPDATE", schema: "public", table: "sales" }, queueSalesRefresh)
            .subscribe();
    }
